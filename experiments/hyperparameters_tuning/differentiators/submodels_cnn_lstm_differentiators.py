...
def test_glove6b(option, function, set_params):
		set_params.update({'embedding_types': [dn.EmbeddingType.GLOVE_6B],
...
def test_glove_twitter_emb(option, function, set_params):
		set_params.update({'embedding_types': [dn.EmbeddingType.GLOVE_TWITTER],
											 'embedding_custom_files': [''],
											 'use_embeddings': [dn.UseEmbedding.STATIC, dn.UseEmbedding.NON_STATIC]})
...
def test_google_news_emb(option, function, set_params):
		set_params.update({'embedding_types': [dn.EmbeddingType.WORD2VEC],
											 'embedding_custom_files': [''],
											 'use_embeddings': [dn.UseEmbedding.STATIC, dn.UseEmbedding.NON_STATIC]})
...
def test_w2v_custom_emb(option, function, set_params):
		set_params.update({'embedding_types': [dn.EmbeddingType.WORD2VEC_CUSTOM],
...
def test_glove_custom_emb(option, function, set_params):
		set_params.update({'embedding_types': [dn.EmbeddingType.GLOVE_CUSTOM],
...
def test_none_emb(option, function, set_params):
		set_params.update({'embedding_types': [dn.EmbeddingType.NONE],
											 'embedding_custom_files': [''],
